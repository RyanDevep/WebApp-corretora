...
<html>
    ...
    <body>
        ...
        <%
        String situacao = request.getParameter("situacao");// recebe o parâmetro do formulário
        ...
        lista = producDAO.consultar_situacao(situacao);// passando o parâmetro
