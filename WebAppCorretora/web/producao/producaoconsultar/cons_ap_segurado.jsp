...
<html>
    <head>
        ...
        <style>
            ...
            h1 { color: #007bff; margin-bottom: 5px; text-align: center; }
    ...
    <body>
        ...
        <%
        String cpfCnpj = request.getParameter("cpf_cnpj");// recebe o parâmetro do formulário
        ...
        lista = producDAO.consultar_cpf_cnpj(cpfCnpj);// Chama o método de consulta
