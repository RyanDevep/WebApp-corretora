...
<html>
    ...
    <body>
        ...
        <%
        String nomeSeguradora = request.getParameter("nome_seguradora");// recebe o parâmetro do formulário
        ...
        lista = producDAO.consultar_seguradora(nomeSeguradora);// Chama o método de consulta
