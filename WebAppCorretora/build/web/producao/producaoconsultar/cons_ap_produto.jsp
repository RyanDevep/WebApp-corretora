...
<html>
    ...
    <body>
        ...
        <%
        String tipoSeguro = request.getParameter("tipo_seguro"); // recebe o parâmetro do formulário
        ...
        lista = producDAO.consultar_produto(tipoSeguro);// Chama o método de consulta
